...
var tutorialApi = 'https://react-ssr-api.herokuapp.com';
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _axios2.default.get(tutorialApi + '/users');
...
var app = (0, _express2.default)(); // polyfill help function for async await syntax
...
app.listen(3000, function () {
  return console.log('port on localhost 3000');
});
...
// will pull everthing for webpack
...
}; // string and escapes bad characters for script tags
